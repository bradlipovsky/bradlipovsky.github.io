...
<section class="research-section">
  <div class="research-section__title">
    <p>Field-building</p>
    <h2>Convening emerging scientific communities</h2>
  </div>
  <div class="research-section__body">
    <p>Brad is organizing the Seismological Society of America’s 2026 special-topics meeting, <em>Optical Seismology and the Next Era of Seismic Sensing</em>, bringing together researchers from Europe, Asia, Oceania, and North America. He previously served as Cryosphere Section Lead for the Distributed Acoustic Sensing Research Coordination Network.</p>
    <p>In 2018, he founded the Environmental Seismology session at the American Geophysical Union Fall Meeting and has helped sustain it as a venue for glacier seismology and related environmental work. He has also contributed through invited federal and national-laboratory advisory panels, international conference leadership, and colloquia in several countries.</p>
    <div class="research-topics">
      <div class="research-topic"><strong>Optical seismology</strong><span>Building an international forum around the next generation of distributed and photonic seismic observations.</span></div>
      <div class="research-topic"><strong>Environmental seismology</strong><span>Creating a durable disciplinary home for glacier, landslide, ocean, and other environmental seismic research.</span></div>
      <div class="research-topic"><strong>Shared methods</strong><span>Open datasets, code, training resources, instrumentation comparisons, and practical guidance for new users.</span></div>
      <div class="research-topic"><strong>Advisory work</strong><span>Contributing technical perspective to agencies, national laboratories, research networks, and scientific infrastructure programs.</span></div>
    </div>
  </div>
</section>
...
<section class="research-section">
  ...
  <div class="research-section__body">
    ...
    <p>Partnerships also extend to the Paros Geohazard Initiative and the University of Sheffield. A UW Global Innovation Fund award supports a joint UW–Sheffield workshop in September 2026 designed to seed interdisciplinary research and long-term collaboration.</p>
  </div>
</section>

<section class="research-section">
  <div class="research-section__title">
    <p>Institutional service</p>
    <h2>Strengthening the department</h2>
  </div>
  <div class="research-section__body">
    <p>Within UW Earth and Space Sciences, Brad has served repeatedly on graduate admissions and introduced a structured applicant-review rubric to support more consistent and equitable decisions. He has also served on the Computing and Executive Committees and contributed to improving office space for postdoctoral scholars.</p>
    <p>These activities complement the group’s approach to mentorship: clear expectations, early conversations about authorship and credit, reproducible work, regular feedback, and support for careers inside and beyond academia.</p>
  </div>
</section>

<div class="callout">
  <p class="eyebrow eyebrow--light">Research community</p>
  <h2>The people are the lasting infrastructure.</h2>
  <p>Students, postdoctoral researchers, collaborating faculty, technical partners, and alumni make the FiberLab and the broader research program possible.</p>
